...
public class MainController extends HttpServlet {
	...
	String localPath = "/MainController";
	String rootPath = "/tpJPA_servlet";
...
//				.getInstance().creategGestionEcoleService();
		...
		response.sendRedirect(rootPath.concat(localPath).concat("/read/"));
	}
