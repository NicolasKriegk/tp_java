...
public class TP12_View extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		buildIHM(request,response, personneSelected);
	}
	...
	private void buildIHM(HttpServletRequest request,
			HttpServletResponse response, Personne personneSelected) throws IOException, ServletException {
		...
		RequestDispatcher dispatcher = request
				.getRequestDispatcher("TP13_header");
