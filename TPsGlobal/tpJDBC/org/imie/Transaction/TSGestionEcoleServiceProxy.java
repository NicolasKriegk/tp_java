...
@Stateless(name="GestionEcoleService")
public class TSGestionEcoleServiceProxy extends AbstractProxy implements IGestionEcoleService,IJDBCCompatible {
	...
	@Inject
	public TSGestionEcoleServiceProxy(@TransactionBeanJDBC(TransactionModeJDBC.REAL) 
IGestionEcoleService service){
		super(service);
	}
...
//	}
	...
	public Personne verifierAuthPersonne(Personne personne)
		...
		PersistanceException persistanceException = null;
		try {
			retour = ((IGestionEcoleService)this.real).verifierAuthPersonne(personne);
		} catch (PersistanceException e) {
			persistanceException = e;
		}
		if (standAloneTransaction) {
