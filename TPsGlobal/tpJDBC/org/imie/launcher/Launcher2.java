...
public class Launcher2 {
	...
	public static void main(String[] args) throws ServiceException {
		final AbstractFactory factory = ConcreteSingletonFactory.getInstance();
		for (int i = 0; i < 20; i++) {
			Thread thread = new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						try {
							((IJDBCCompatible) dao).beginTransaction();
						...
						((IJDBCCompatible) dao).endTransaction(persistanceException );
					} catch (PersistanceException e) {
