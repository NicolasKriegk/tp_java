...
public class Launcher {
	...
	public static void main(String[] args) throws PersistanceException {
		...
		Integer lineToUpdate = null;
		Integer lineToDelete = null;
		...
		while (applicationRun) {
			...
			case 1:
				...
				personnes.clear();
				personnes = personneDAO.rechercherPersonne(nomInput);
			...
			case 2:
				...
				personnes.clear();
				personnes = personneDAO.rechercherPersonne(currentPersonne);
				displayPersonnes(simpleDateFormat, personnes);
				break;
			case 3:
				currentPersonne = setPersonne(simpleDateFormat, scanIn);

				Personne insertedPersonne = personneDAO
			...
			case 5:
				...
				lineToUpdate = Integer.valueOf(scanIn.nextInt());
				scanIn.nextLine();
				// récupération de la personne dans la liste qui a servi à
				// l'affichage
				...
				break;
			case 6://suppression promotion
				promotions.clear();
				promotions = promotionDAO.rechercherPromotion(new Promotion());
				...
				// récupération de la personne dans la liste qui a servi à
				// l'affichage
				Promotion promotionToDelete = promotions.get(lineToDelete);
//				promotionToDelete = setPromotion(scanIn,
//						promotionToDelete);
				promotionDAO.deletePromotion(promotionToDelete);
				break;
			case 0:
				// fin d'application
	...
	private static Personne setPersonne(SimpleDateFormat simpleDateFormat,
			Scanner scanIn) throws PersistanceException {
	 ...
	 */
	private static Personne setPersonne(SimpleDateFormat simpleDateFormat,
			Scanner scanIn, Personne personneOrigin) throws PersistanceException {
		String nomInput;
		String prenomInput;
		String passwInput;
		Date dateNaissInput = null;
		...
		IPromotionDAO promotionDAO = new PromotionDAO();
		List<Promotion> promotions = promotionDAO.rechercherPromotion(new Promotion());
...
//	 * @throws PersistanceException
//	 */
//	private static Promotion setPromotion(Scanner scanIn) throws PersistanceException {
//		return setPromotion(scanIn, null);
//	}
//
//	/**
//	 * @param simpleDateFormat
...
//	 * @throws PersistanceException
//	 */
//	private static Promotion setPromotion(Scanner scanIn, Promotion promotionOrigin) throws PersistanceException {
//		String libelleInput;
//		System.out.println("saisir libelle :");
//		if (promotionOrigin != null && promotionOrigin.getLibelle() != null) {
//			System.out.print(promotionOrigin.getLibelle());
//		}
//		libelleInput = scanIn.nextLine();
//
//
//
//		String promotionInput = null;
