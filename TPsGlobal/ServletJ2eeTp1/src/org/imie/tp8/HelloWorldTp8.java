 ...
 */
@WebServlet(
		urlPatterns = { "/HelloWorldTp8" }, 
		initParams = { 
				@WebInitParam(name = "design", value = "rouge"),
		})
public class HelloWorldTp8 extends HttpServlet {
...
//			response.sendRedirect("./TableauTp8");
//		}
//		else if("forward".equals(request.getParameter("mode"))){
//			ServletContext context= request.getSession().getServletContext();
//			RequestDispatcher rd = context.getRequestDispatcher("/TableauTp8");
...
//		else if("include".equals(request.getParameter("mode"))){
			...
			ServletContext context= request.getSession().getServletContext();
			RequestDispatcher rd= context.getRequestDispatcher("/TableauTp8Include");
