...
/**
 * Servlet implementation class TableauTp8
 */
@WebServlet("/TableauTp8Include")
public class TableauTp8Include extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TableauTp8Include() {
        super();
...
//		if(request.getParameter("ligne") == null){
			...
			tableauWriter =tableauWriter.concat("<th>N°</br>(cliquable)</th><th>Nom</th><th>Prenom</th><th>Date de naissance</th><th>Id</th>");
...
//				tableauWriter =tableauWriter.concat("<td><a href=\"./HelloWorldTp8?mode=include&ligne=")
				tableauWriter =tableauWriter.concat("<td><a href=\"./HelloWorldTp8?ligne=")
				...
				tableauWriter =tableauWriter.concat("<td><a href=\"./HelloWorldTp8?id=")
